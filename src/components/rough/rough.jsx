...
import author from "../assets/AboutAuthor/author.jpeg"; // Corrected spelling of 'author'
import author1 from "../assets/AboutAuthor/author1.png"; // Corrected spelling of 'author'
import author2 from "../assets/AboutAuthor/author2.png"; // Corrected spelling of 'author'
import author3 from "../assets/AboutAuthor/author3.png"; // Corrected spelling of 'author'
import author4 from "../assets/AboutAuthor/author4.png"; // Corrected spelling of 'author'
...
const AboutAuthor = () => {
  ...
  const handleNav = () => {
    setNav((prevNav) => !prevNav); // Toggle mobile menu state
  };
  ...
  return (
    <section className="w-full flex justify-center items-center flex-col ">
      ...
      <div className="flex flex-col  justify-center items-center w-[90%] max-md:w-[90%] gap-10  font-Minion max-md:mt-10">
        <div className="flex mt-10 justify-center items-start flex-row-reverse max-md:items-center max-lg:flex-col gap-10 ">
          <div className="flex flex-col  w-full ">
            <div className="w-full max-md:flex-col  flex flex-row-reverse justify-between items-start gap-10 mb-20">
              <img
                loading="lazy"
                src={author}
                alt="Author Varun Wadhwa"
                className="mb-5 w-[30rem] rounded-lg"
              />
              <div className="">
            ...
            <div className="flex max-md:flex-col gap-10 mb-20 w-full justify-center items-start">
              <img
                loading="lazy"
                src={author4}
                alt="Author Varun Wadhwa"
                className="mb-5 w-[60rem] rounded-lg"
              />
              <div className="">
                <h1 className="text-3xl font-europa font-bold mb-10 text-center underline">
                  Consultant
                </h1>
                <div className="">
                  <p className="mb-2  text-lg ">
                    As a consultant, I work with professionals, teaching them{" "}
                    <strong>The Art of Becoming Indispensable at work</strong>{" "}
                    so they can:
                  </p>
                ...
                <h1 className=" mb-2 text-lg mt-5 ">
                ...
                <div className="flex flex-col pl-3">
                  {[
                    ...
                    <li
                      key={index}
                      className="mb-2 items-start list-disc max-md:text-left text-lg max-md:text-lg max-sm:text-base flex gap-2"
                    >
                      <img
                        loading="lazy"
                        src={check}
            ...
            <div className="w-full justify-center items-center flex">
              <div className="flex max-md:flex-col flex-row-reverse gap-10 mb-20 w-[95%] justify-center items-start">
                <img
                  loading="lazy"
                  src={author2}
                  alt="Author Varun Wadhwa"
                  className="mb-5 w-[70rem] rounded-lg"
                />
                <div className="">
                  <h1 className="text-3xl font-bold font-europa mb-10 text-center underline">
                    Public Speaker
                  </h1>
                  <p className="text-lg mb-5 text-justify max-md:text-center">
            ...
            <div className="flex max-md:flex-col gap-10 mb-10 w-full justify-center items-center ">
              <img
                ...
                src={author3}
                alt="Author Varun Wadhwa"
                className=" w-[100rem] rounded-lg"
              />
              {/* Other Interests Section */}

              <div className="flex-col gap-5 flex  ">
                <h1 className="text-3xl mb-10 mt-0 font-bold font-europa text-center underline">
                  Other Interests
                </h1>
                <div className="">
        ...
        {/* Consultant Section */}
        <div className="w-[70%] max-md:w-[95%]"></div>
      </div>
    </section>
  );
};

export default AboutAuthor; // Exporting the corrected component
